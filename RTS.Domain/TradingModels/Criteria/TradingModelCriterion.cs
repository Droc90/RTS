...
namespace RTS.Domain.TradingModels.Criteria;

public sealed class TradingModelCriterion
{
    private TradingModelCriterion()
    {
    }
    ...
    internal static TradingModelCriterion Create(
        string name,
        string metricKey,
        RulePurpose purpose,
        ...
        int displayOrder)
    {
        ...
        return new TradingModelCriterion
        {
        ...
        RuleValue? secondaryValue)
    {
        ...
        if (isRangeOperator && secondaryValue is null)
        {
        ...
        if (!isRangeOperator && secondaryValue is not null)
        {
            throw new ArgumentException(
