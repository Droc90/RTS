...
(
    [Id]                    bigint IDENTITY(1,1) NOT NULL,
    [ExternalId]            uniqueidentifier NOT NULL CONSTRAINT [DF_TradingModelCriteria_ExternalId] DEFAULT (NEWID()),
    [TradingModelVersionId] bigint NOT NULL,
    [Name]                  nvarchar(150) NOT NULL,
    ...
    [DisplayOrder]          int NOT NULL,
    [IsEnabled]             bit NOT NULL CONSTRAINT [DF_TradingModelCriteria_IsEnabled] DEFAULT (1),
    [RowVersion]            rowversion NOT NULL,
    CONSTRAINT [PK_TradingModelCriteria] PRIMARY KEY CLUSTERED ([Id]),
    CONSTRAINT [CK_TradingModelCriteria_Purpose] CHECK ([Purpose] IN (1, 2, 3)),
    CONSTRAINT [CK_TradingModelCriteria_Operator] CHECK ([ComparisonOperator] BETWEEN 1 AND 12),
    CONSTRAINT [CK_TradingModelCriteria_PrimaryValueType] CHECK ([PrimaryValueType] IN (1, 2, 3, 4, 5)),
    CONSTRAINT [CK_TradingModelCriteria_SecondaryValueType] CHECK ([SecondaryValueType] IS NULL OR [SecondaryValueType] IN (1, 2, 3, 4, 5)),
    ...
    CONSTRAINT [CK_TradingModelCriteria_Weight] CHECK (([Purpose] = 2 AND [Weight] > 0 AND [Weight] <= 100) OR ([Purpose] <> 2 AND [Weight] IS NULL)),
    CONSTRAINT [CK_TradingModelCriteria_DisplayOrder] CHECK ([DisplayOrder] > 0)
);

CREATE TABLE [Trading].[ScreeningStrategies]
(
    [Id]          bigint IDENTITY(1,1) NOT NULL,
    [ExternalId]  uniqueidentifier NOT NULL CONSTRAINT [DF_ScreeningStrategies_ExternalId] DEFAULT (NEWID()),
    [OwnerUserId] bigint NULL,
    [Name]        nvarchar(200) NOT NULL,
    [Description] nvarchar(2000) NULL,
    [IsActive]    bit NOT NULL CONSTRAINT [DF_ScreeningStrategies_IsActive] DEFAULT (1),
    [CreatedUtc]  datetime2(3) NOT NULL CONSTRAINT [DF_ScreeningStrategies_CreatedUtc] DEFAULT (SYSUTCDATETIME()),
    [RowVersion]  rowversion NOT NULL,
    CONSTRAINT [PK_ScreeningStrategies] PRIMARY KEY CLUSTERED ([Id])
);

CREATE TABLE [Trading].[ScreeningStrategyVersions]
(
    [Id]                  bigint IDENTITY(1,1) NOT NULL,
    [ExternalId]          uniqueidentifier NOT NULL CONSTRAINT [DF_ScreeningStrategyVersions_ExternalId] DEFAULT (NEWID()),
    [ScreeningStrategyId] bigint NOT NULL,
    [VersionNumber]       int NOT NULL,
    [Status]              int NOT NULL,
    [CreatedUtc]          datetime2(3) NOT NULL CONSTRAINT [DF_ScreeningStrategyVersions_CreatedUtc] DEFAULT (SYSUTCDATETIME()),
    [PublishedUtc]        datetime2(3) NULL,
    [RowVersion]          rowversion NOT NULL,
    CONSTRAINT [PK_ScreeningStrategyVersions] PRIMARY KEY CLUSTERED ([Id]),
    CONSTRAINT [CK_ScreeningStrategyVersions_VersionNumber] CHECK ([VersionNumber] > 0),
    CONSTRAINT [CK_ScreeningStrategyVersions_Status] CHECK ([Status] IN (1, 2, 3)),
    CONSTRAINT [CK_ScreeningStrategyVersions_PublishedState] CHECK (([Status] = 1 AND [PublishedUtc] IS NULL) OR ([Status] IN (2, 3) AND [PublishedUtc] IS NOT NULL)),
...
(
    [Id]                         bigint IDENTITY(1,1) NOT NULL,
    [ExternalId]                 uniqueidentifier NOT NULL CONSTRAINT [DF_ScreeningRules_ExternalId] DEFAULT (NEWID()),
    ...
    [Weight]                     decimal(9,4) NULL,
    [DisplayOrder]               int NOT NULL,
    [IsEnabled]                  bit NOT NULL CONSTRAINT [DF_ScreeningRules_IsEnabled] DEFAULT (1),
    [RowVersion]                 rowversion NOT NULL,
    CONSTRAINT [PK_ScreeningRules] PRIMARY KEY CLUSTERED ([Id]),
    CONSTRAINT [CK_ScreeningRules_Purpose] CHECK ([Purpose] IN (1, 2, 3)),
    CONSTRAINT [CK_ScreeningRules_Operator] CHECK ([ComparisonOperator] BETWEEN 1 AND 12),
    CONSTRAINT [CK_ScreeningRules_PrimaryValueType] CHECK ([PrimaryValueType] IN (1, 2, 3, 4, 5)),
    ...
    CONSTRAINT [CK_ScreeningRules_Weight] CHECK (([Purpose] = 2 AND [Weight] > 0 AND [Weight] <= 100) OR ([Purpose] <> 2 AND [Weight] IS NULL)),
    CONSTRAINT [CK_ScreeningRules_DisplayOrder] CHECK ([DisplayOrder] > 0)
);
...
ALTER TABLE [Trading].[TradingModelCriteria] ADD CONSTRAINT [FK_TradingModelCriteria_TradingModelVersion]
    FOREIGN KEY ([TradingModelVersionId]) REFERENCES [Trading].[TradingModelVersions]([Id]);
ALTER TABLE [Trading].[ScreeningStrategies] ADD CONSTRAINT [FK_ScreeningStrategies_OwnerUser]
    FOREIGN KEY ([OwnerUserId]) REFERENCES [Identity].[Users]([Id]);
ALTER TABLE [Trading].[ScreeningStrategyVersions] ADD CONSTRAINT [FK_ScreeningStrategyVersions_ScreeningStrategy]
    FOREIGN KEY ([ScreeningStrategyId]) REFERENCES [Trading].[ScreeningStrategies]([Id]);
ALTER TABLE [Trading].[ScreeningRules] ADD CONSTRAINT [FK_ScreeningRules_ScreeningStrategyVersion]
    FOREIGN KEY ([ScreeningStrategyVersionId]) REFERENCES [Trading].[ScreeningStrategyVersions]([Id]);
