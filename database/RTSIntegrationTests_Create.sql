/*
    RTSIntegrationTests - Ranked Trading System Integration Test Database
    Target: SQL Server 2025 Developer Edition (compatibility level 170) / Azure SQL Database
    Purpose: Isolated database for Ranked Trading System integration tests
...
IF DB_ID(N'RTSIntegrationTests') IS NULL
BEGIN
    EXEC(N'CREATE DATABASE [RTSIntegrationTests]');
END;
GO

USE [RTSIntegrationTests];
GO

ALTER DATABASE [RTSIntegrationTests]
...
PRINT N'RTSIntegrationTests creation completed successfully.';
GO
