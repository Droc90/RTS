...
public sealed class MarketDataServiceTests
{
    ...
    private sealed class StubProvider(IReadOnlyCollection<PriceBar> bars) : IMarketPriceDataProvider
    {
        ...
        public Task<IReadOnlyCollection<CorporateAction>> GetCorporateActionsAsync(string symbol, DateTime fromUtc, DateTime toUtc, CancellationToken cancellationToken = default) => throw new NotSupportedException();
    }
}
